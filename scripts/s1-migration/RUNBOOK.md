...
| `sirius_id_collision`, `sirius_id_owned_by_other_row` | contacts-workers | not present | Row is NOT loaded — expect 0; any occurrence is a stop-and-triage item (fund verified field_sirius_id uniqueness on prod) |
