...
export const workerTabTree: HierarchicalTab[] = [
  ...
  { 
    ...
    children: [
      ...
      { id: 'relations', label: 'Relations', hrefTemplate: '/workers/{id}/relations', policyId: 'worker.view', component: 'worker.relations' },
    ]
  },
  { 
    ...
    children: [
      ...
      { id: 'log-call', label: 'Log Call', hrefTemplate: '/workers/{id}/comm/log-call', permission: 'staff' },
  ...
  { 
    id: 'employment', label: 'Employment', hrefTemplate: '/workers/{id}/employment/monthly', policyId: 'worker.view',
    children: [
      ...
      { id: 'tos', label: 'Time Off Sick', hrefTemplate: '/workers/{id}/employment/tos', permission: 'staff', component: 'worker.tos' },
    ]
  },
  { 
    id: 'benefits', label: 'Benefits', hrefTemplate: '/workers/{id}/benefits/current', policyId: 'worker.view',
    children: [
...
export const policyTabTree: HierarchicalTab[] = [
  ...
  { id: 'eligibility', label: 'Eligibility', hrefTemplate: '/policies/{id}/eligibility', permission: 'admin' },
];
...
/**
 * Trust election entity tab tree
 */
...
export const userTabTree: HierarchicalTab[] = [
  ...
  { 
    ...
    children: [
      ...
      { id: 'log-call', label: 'Log Call', hrefTemplate: '/users/{id}/comm/log-call', permission: 'staff' },
