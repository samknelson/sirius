...
export const workerTabTree: HierarchicalTab[] = [
  ...
  { id: 'sitespecific-freeman-2shift', label: 'Second Shift', hrefTemplate: '/workers/{id}/sitespecific-freeman-2shift', policyId: 'edls.coordinator', component: 'sitespecific.freeman' },
