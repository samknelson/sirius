...
export const entityMetadataContexts: Record<string, MetadataRecordContext> = {
  ...
  sitespecific_bao_cobra_cases: context(coreSchema.sitespecificBaoCobraCases, "BAO COBRA Cases", null),
  ...
  sitespecific_bao_premium_rates: context(coreSchema.sitespecificBaoPremiumRates, "BAO Premium Rates", null),
  sitespecific_bao_rate_sources: context(coreSchema.sitespecificBaoRateSources, "BAO Rate Sources", null),
  sitespecific_bao_withholding_allocations: context(coreSchema.sitespecificBaoWithholdingAllocations, "BAO Withholding Allocations", null),
