...
registerEnvironmentVariables([
  ...
  { name: "CHROMIUM_EXECUTABLE_PATH", description: "Optional absolute path to the Chromium executable used for PDF letter rendering. Empty uses runtime discovery (/usr/bin/chromium, then /repl/tools/bin/chromium, then chromium on PATH).", secret: false, category: "core", changeTakesEffect: "immediate", transform: (value) => value ?? "" },
