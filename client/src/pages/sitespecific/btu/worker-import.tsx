  ...
  const createWizardMutation = useMutation({
    ...
    onSuccess: (newWizard: Wizard) => {
      ...
      toast({
        ...
        description: "New BTU Worker Import wizard created.",
      });
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl md:text-2xl font-bold" data-testid="page-title">BTU Worker Import</h1>
          <p className="text-muted-foreground">Import workers from BPS roster files</p>
        </div>
        <Button
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            View and manage your BTU worker import wizards
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
