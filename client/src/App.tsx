...
const WorkerBaoDp = lazy(() => import("@/pages/worker-sitespecific-bao-dp"));
...
const EnrollmentQueue = lazy(() => import("@/pages/trust/enrollment-queue"));
...
const BaoDpWorkersPage = lazy(() => import("@/pages/sitespecific/bao/dp-workers"));
...
const PolicyEligibility = lazy(() => import("@/pages/policy-eligibility"));
...
function Router() {
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      ...
      <Route path="/workers/:id/sitespecific-freeman-2shift">
      ...
      <Route path="/workers/:id/sitespecific/bao/dp">
        <ProtectedRoute tabId="sitespecific-bao-dp" entityType="worker">
          <AuthenticatedLayout>
            <WorkerBaoDp />
          </AuthenticatedLayout>
        </ProtectedRoute>
      ...
      <Route path="/trust/enrollment-queue">
      ...
      <Route path="/sitespecific/btu/cardcheck-sig-import">
        <ProtectedRoute permission="admin" component="sitespecific.btu">
          <AuthenticatedLayout>
            <BtuCardcheckSigImportPage />
          </AuthenticatedLayout>
        </ProtectedRoute>
      </Route>

      <Route path="/sitespecific/btu/cardcheck-scrape-import">
        <ProtectedRoute permission="admin" component="sitespecific.btu">
          <AuthenticatedLayout>
            <BtuCardcheckScrapeImportPage />
          </AuthenticatedLayout>
        </ProtectedRoute>
      </Route>

      <Route path="/sitespecific/btu/building-rep-import">
        <ProtectedRoute permission="admin" component="sitespecific.btu">
          <AuthenticatedLayout>
            <BtuBuildingRepImportPage />
          </AuthenticatedLayout>
        </ProtectedRoute>
      </Route>
      ...
      <Route path="/policies/:id/eligibility">
        <ProtectedRoute tabId="eligibility" entityType="policy">
          <AuthenticatedLayout>
            <PolicyEligibility />
          </AuthenticatedLayout>
        </ProtectedRoute>
      ...
      <Route path="/config/trust/open-enrollment-windows">
        <ProtectedRoute permission="admin" component="trust.elections">
          <AuthenticatedLayout>
            <ConfigurationLayout>
              <OpenEnrollmentWindowsPage />
            </ConfigurationLayout>
          </AuthenticatedLayout>
        </ProtectedRoute>
      </Route>
      ...
      <Route path="/config/sitespecific/bao/employer-rates">
        <ProtectedRoute permission="admin" component="sitespecific.bao">
          <AuthenticatedLayout>
            <ConfigurationLayout>
              <BaoEmployerRatesPage />
            </ConfigurationLayout>
          </AuthenticatedLayout>
        </ProtectedRoute>
      </Route>

      <Route path="/config/sitespecific/bao/rate-sources">
        <ProtectedRoute permission="admin" component="sitespecific.bao">
          <AuthenticatedLayout>
            <ConfigurationLayout>
              <BaoRateSourcesPage />
      ...
      <Route path="/config/sitespecific/bao/dp-rates">
        <ProtectedRoute permission="admin" component="sitespecific.bao">
          <AuthenticatedLayout>
            <ConfigurationLayout>
              <BaoDpRatesPage />
      ...
      <Route path="/bao/dc/fmla-eligible">
        <ProtectedRoute permission="staff" component="sitespecific.bao">
          <AuthenticatedLayout><BaoDcFmlaEligiblePage /></AuthenticatedLayout>
        </ProtectedRoute>
      </Route>
      ...
      <Route path="/bao/dp/workers">
        <ProtectedRoute permission="staff" component="sitespecific.bao">
          <AuthenticatedLayout><BaoDpWorkersPage /></AuthenticatedLayout>
        </ProtectedRoute>
      </Route>
