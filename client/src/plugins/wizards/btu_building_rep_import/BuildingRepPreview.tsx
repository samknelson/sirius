...
export function BuildingRepPreview({ data }: WizardStepComponentProps) {
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex flex-col items-center justify-center p-12 space-y-4">
            ...
            <p className="text-muted-foreground" data-testid="text-no-preview">
  ...
  const sortedReasons = Array.from(errorsByReason.entries()).sort(
    (a, b) => b[1] - a[1],
  );
        ...
        <Card>
          <CardContent className="pt-6">
            <div
              ...
              data-testid="text-already-assigned"
            >
            ...
            <div className="space-y-2">
              {sortedReasons.map(([reason, count], idx) => (
                <div
                  ...
                  data-testid={`preview-reason-${idx}`}
                >
              ...
              <Table>
                ...
                <TableBody>
                  {alreadyAssigned.map((row, idx) => (
                    <TableRow
                      key={idx}
                      data-testid={`row-already-assigned-${idx}`}
                    >
                      <TableCell>
                        {row.workerId ? (
                          <Link
