          ...
          {isComplete && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-2xl font-bold text-blue-600">{(processResults.skippedDuplicate?.length || processResults.updatedCount).toLocaleString()}</div>
                    <div className="text-sm text-muted-foreground">Duplicates Skipped</div>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="pt-6">
                    <div className="text-2xl font-bold text-red-600">{(processResults.notFoundBpsIds?.length || processResults.failureCount).toLocaleString()}</div>
