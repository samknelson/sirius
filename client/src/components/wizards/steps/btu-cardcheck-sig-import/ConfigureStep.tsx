      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                All imported signatures will be linked to card checks of this type.
              </p>
            </div>
          </div>
          ...
          <Alert>
            ...
            <AlertDescription>
              Each PDF in the ZIP file will be matched to a worker by BPS Employee ID extracted from the filename.
              For each matched file, an offline e-signature record will be created and linked to the worker's card check.
              If no card check exists, one will be created with "signed" status.
            </AlertDescription>
          </Alert>
