...
- **Shared-dev-DB state**: tests that toggle component enablement or delete settings variables reconfigure the RUNNING dev app — always capture the original value first and restore it in afterAll.
